...
Trois patrons, choisis parce qu'ils règlent un problème précis de ce projet. Voir [05-architecture-logicielle.md](05-architecture-logicielle.md) pour les composants.
