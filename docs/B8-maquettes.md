...
<img src="assets/01-connexion.png" alt="Écran d'inscription et de connexion" width="300">
...
<img src="assets/02-tableau-de-bord.png" alt="Tableau de bord du jour" width="300">

### 3. Créneaux

Les quatre rangées et leur heure. Le patient choisit une heure pour chacune.

<img src="assets/03-creneaux.png" alt="Écran des créneaux" width="300">

### 4. Médicaments

Liste des médicaments, formulaire d'ajout, choix du créneau et des jours.

<img src="assets/04-medicaments.png" alt="Écran des médicaments" width="300">
...
<img src="assets/05-remplissage.png" alt="Écran de confirmation du remplissage" width="300">
...
C'est l'écran le plus important de l'application : il montre que le système ne tranche pas quand il doute.

<img src="assets/06-resultat.png" alt="Écran de résultat d'une prise" width="300">

### 7. Historique

Les prises passées, de la plus récente à la plus ancienne, avec leur statut. On ne peut rien modifier ni supprimer.

<img src="assets/07-historique.png" alt="Écran d'historique" width="300">
...
<img src="assets/08-demonstration.png" alt="Écran de démonstration" width="300">
